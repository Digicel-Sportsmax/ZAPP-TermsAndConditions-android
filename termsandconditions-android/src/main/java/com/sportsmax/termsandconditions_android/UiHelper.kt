...
class UiHelper {
    companion object {
        ...
        fun updateButtonStyle(button: Button?, text: String, backgroundColor: String, textColor: String) {
            if (button != null) {
                var textValue = PluginConfigurationHelper.getConfigurationValue(text)
                textValue = if (StringUtil.isNotEmpty(textValue)) textValue else text
                button.text = textValue

                var textColorValue = PluginConfigurationHelper.getConfigurationValue(textColor)
                ...
                var bgColorValue = PluginConfigurationHelper.getConfigurationValue(backgroundColor)
        ...
        fun getValue(resource: String) : String? {
            var resourceValue = PluginConfigurationHelper.getConfigurationValue(resource)
